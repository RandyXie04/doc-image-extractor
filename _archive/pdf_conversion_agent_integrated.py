...
class PDFConversionAgent:
    ...
    def __init__(self, input_pdf: str, output_docx: str = None, preview_dir: str = "previews", formula_dir: str = "extracted_formulas_mfd-2", header_ratio: float = 0.15, footer_ratio: float = 0.92):
    ...
    def convert_to_word(self, log_fn=print) -> bool:
        """
    ...
    def extract_formulas(self, dpi: int = 300, start_page_idx: int = 0, end_page_idx: int = None, log_fn=print) -> list:
        ...
        log_fn("\n" + "=" * 60)
        log_fn("[AI] 正在載入 Pix2Text 開源 MFD 深度學習模型...")
